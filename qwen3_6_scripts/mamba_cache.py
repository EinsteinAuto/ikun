    ...
    def _clean_up_first_bs_blocks(self, batch_size: int,
        ...
        for destination_index in destination_indices:
            ...
            if (destination_index in all_occupied
                ...
                # which swaps both the cache tensor data AND the index
                # mapping dict — both must move together when relocating
                # an occupied-but-inactive entry out of the active batch
                # window.
                #
                ...
                # vllm/model_executor/models/mamba_cache.py uses a
                # completely different ConstantSizeCache base and does
                # not have this code path.
                #
